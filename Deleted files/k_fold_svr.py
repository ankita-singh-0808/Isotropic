...
pipeline = Pipeline([
    ...
    ('svr', SVR(kernel='rbf', C=1.0, epsilon=0.1))  # You can tune C and epsilon
])
...
plt.scatter(y, y_pred, alpha=0.6, color='teal', label='Cross-Validated Predictions')
...
# R² plot
plt.subplot(1, 2, 1)
sns.barplot(x=fold_labels, y=r2_scores, palette='viridis')
...
# MSE plot
plt.subplot(1, 2, 2)
sns.barplot(x=fold_labels, y=mse_scores, palette='mako')
